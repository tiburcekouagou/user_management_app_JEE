			...
			<div class="card-body">
				<form action="saveuser" method="post">
					...
					<fieldset class="form-group mb-3">
						<label for="country">User Country</label> <select id="country"
							name="country" required="required" class="form-select text-black"><option
								value="" selected="selected">Choisissez votre
								nationalité...</option>
